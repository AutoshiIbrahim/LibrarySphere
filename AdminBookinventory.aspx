<%@ Page Title="Book Inventory" Language="C#" MasterPageFile="~/Admin/AdminSite.Master" AutoEventWireup="true" CodeBehind="AdminBookinventory.aspx.cs" Inherits="LibrarySphere.Admin.AdminBookinventory" %>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col">
                                <center>
                                    <%--<img id="imgview" src="../Imgs/book1.png" height="150" width="150" alt="" />--%>
                                    <asp:Image ID="ImgPhoto" ImageUrl="../Imgs/book1.png" runat="server" Height="150" Width="150" alt="" />                         
                                </center>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <asp:DropDownList class="form-control" ID="ddlLanguage" runat="server">
                                        ...
                                        <asp:ListItem Text="Bengali" Value="Hindi" />
                                        <asp:ListItem Text="Spanish" Value="Marathi" />
                                        <asp:ListItem Text="French" Value="French" />
                                        <asp:ListItem Text="German" Value="German" />
                                        <asp:ListItem Text="Hindi" Value="Urdu" />
                                                        ...
                                                        <div class="col-lg-10">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-12">
                                                                    ...
                                                                    &nbsp;| Edition -
                                                                    <asp:Label ID="Label8" runat="server" Font-Bold="True" Text='<%# Eval("edititon") %>'></asp:Label>
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col-12">
