<%@ Page Title="Issue & Return" Language="C#" MasterPageFile="~/Admin/AdminSite.Master" AutoEventWireup="true" CodeBehind="bookIssueReturn.aspx.cs" Inherits="LibrarySphere.Admin.bookIssueReturn" %>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <asp:GridView class="table table-striped table-bordered table-sm" ID="GridView1" Font-Size="Small" runat="server" AutoGenerateColumns="False" EmptyDataText="No Records Found!" OnRowDataBound="GridView1_RowDataBound">
                                    <Columns>
