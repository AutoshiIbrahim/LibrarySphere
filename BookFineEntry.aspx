<%@ Page Title="Book Fine" Language="C#" MasterPageFile="~/Admin/AdminSite.Master" AutoEventWireup="true" CodeBehind="BookFineEntry.aspx.cs" Inherits="LibrarySphere.Admin.BookFineEntry" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container-fluid">
        <div class="row border align-content-center" id="A1" runat="server">
            ...
            <p> &nbsp;Please pay the fine amount ...  </p>
            <div>
                Amount (Tk.):
